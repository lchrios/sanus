...
const UserProfileSidenav = ({ ther_data }) => {
    ...
    const [displayTherapy, setDisplay] = useState(ther_data !== undefined);   
            ...
            <div>
                <div className={clsx('flex-column items-center', classes.sidenav)}>
                    ...
                    <div className="px-8 pt-2 bg-default">
                        ...
                        <div className="py-4" />
                        <div className="flex items-center justify-center text-primary" style={{ display: displayTherapy ? "block" : "none" }}>
                                <Button onClick={() => {

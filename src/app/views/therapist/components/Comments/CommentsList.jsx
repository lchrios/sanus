...
import { IconButton, Icon, Checkbox, Avatar, MenuItem, Button, Card } from '@material-ui/core'
import { MatxMenu } from 'app/components'
import { format } from 'date-fns'
import { getTimeDifference } from 'utils'

const CommentsList = ({ messageList, handleCheckboxSelection }) => {
                        ...
                        <div className="flex items-center w-full px-2">
                            ...
                            >
                                <MenuItem className="flex items-center">
                                    <Icon className="mr-4">reply</Icon> Responder
                                </MenuItem>
                                <MenuItem className="flex items-center">
                                    <Icon className="mr-4">archive</Icon>{' '} Guardar
                                </MenuItem>
                                <MenuItem className="flex items-center">
                                    <Icon className="mr-4">delete</Icon> Borrar
                                </MenuItem>
                            </MatxMenu>
                        </div>

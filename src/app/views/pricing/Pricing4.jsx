                    ...
                    <table className={classes.table}>
                        <tbody>
                            <tr>
                                ...
                                {['Essential', 'Premium', 'Enterprise'].map(
                                    (item, ind) => (
                                        <td key={ind}>
                                            <div className="text-center">
                                                <h5 className="font-medium text-14">
                                                    {item}
                                                </h5>
                                                <p className="text-muted">
                                                    All the basics for event
                                                    &amp; team crowdfunding
                                                </p>
                                                <Button
                            ...
                            <tr>
                                <td className="pt-8">
                                    <h5 className="font-medium text-14 mb-0">
                                        Pricing
                                    </h5>
                                </td>
                            </tr>

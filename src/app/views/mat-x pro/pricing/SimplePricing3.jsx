            ...
            <div>
                <Grid container spacing={3}>
                    <Grid item md={4} sm={12} xs={12}>
                        <Card elevation={3} className="px-6 h-full">
                            ...
                            <p className="">
                                ...
                                adipiscing elit. Aliquam tempus vestibulum
                                vestibulum. Nunc nec feugiat ligula. In porta
                                feugiat purus et ornare.Integer tempor, sapien
                                scelerisque commodo molestie, ante lacus dapibus
                                ligula
                            </p>
                        </Card>
                    </Grid>
                    <Grid item md={4} sm={12} xs={12}>
                        <Card
                            elevation={3}
                            className="px-6 py-14 flex-column items-center h-full"
                        >
                            <Icon className="text-72 mb-14 text-primary">
                                flight
                            </Icon>
                            <h4 className="text-22 font-normal mb-5">
                                Startup
                            </h4>
                    ...
                    <Grid item md={4} sm={12} xs={12}>
                        <Card
                            elevation={3}
                            className={clsx({
                                'px-6 py-14 flex-column items-center bg-primary text-white h-full': true,

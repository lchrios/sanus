...
exports.expressAccount = function (req, res) {
  ...
  var account = stripe.accounts.create({
    ...
    ][0]; // TODO: Validar que no tenga cuenta creada con un stripe account retrieve

    thers.where("stripeId", "!=", undefined).get().then(function (query) {
      query.forEach(function (doc) {});
    });
    stripe.accountLinks.create({
      account: response.id,
      refresh_url: "".concat(host, "/").concat(req.params.tid, "/connectFailed"),
...
exports.validateStripe = function (req, res) {
